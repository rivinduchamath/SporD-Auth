...
INSERT INTO oauth_client_details (client_id, client_secret, web_server_redirect_uri, scope, access_token_validity, refresh_token_validity, resource_ids, authorized_grant_types, additional_information) VALUES ('Web', '{bcrypt}$2a$12$v7BWLKlyF5H1k8NBYBvBI.C5SBziVSRZDpmW/6Es9kGpxe3l.dbKu', 'http://cogv5qa.incubatelabs.com/api/v5/oauth/api/v5/token', 'READ,WRITE', '999999999', '999999999', 'inventory,payment', 'authorization_code,password,refresh_token,implicit', '{}');
...
INSERT INTO auth_role (id, NAME) VALUES
                                (201,'ROLE_admin'),(202,'ROLE_operator'),(203,'ROLE_editor'),(204,'ROLE_user');
...
insert into auth_user (id,
                       ...
                       account_non_locked,
                       auth_type,
                       failedAttempt, lockTime
                       ) VALUES ('1',
                                                   'CogAdmin',
                                                   '{bcrypt}$2a$12$v7BWLKlyF5H1k8NBYBvBI.C5SBziVSRZDpmW/6Es9kGpxe3l.dbKu',
                                                   'Chamath',
                                                   true,
                                                   true,
                                                   true,
...
insert into auth_user (id,
          ...
          '{bcrypt}$2a$12$v7BWLKlyF5H1k8NBYBvBI.C5SBziVSRZDpmW/6Es9kGpxe3l.dbKu','Chamath2',  true,true,true,true,
          'Facebook',0, null);
