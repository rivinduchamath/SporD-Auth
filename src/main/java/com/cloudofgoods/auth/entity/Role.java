...
public class Role implements SuperEntity {
    public static final int ROLE_user = 204;
    public static final int ROLE_admin = 201;
    public static final int ROLE_operator = 202;
    public static final int ROLE_editor = 203;
    @Id
